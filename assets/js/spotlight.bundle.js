...
(function () {
  ...
  // find clicked on spotlight element
  function $a(a) {
  ...
  function tb(a) {
    ...
    N = L.firstChild;
    z = a;
    if (N) x && V(), Aa && d(N, Aa, true), rb(true), J && d(N, J), Ja && g(N, "opacity", 1), Ia && g(N, "transform", ""), g(N, "visibility", "visible"), g(N, "padding", "3em"), g(N, "padding-bottom", "5em"), Q && (La.src = Q), H && ub(R); else {
      ...
      }, N.poster = D.poster, N.preload = Da ? "auto" : "metadata", N.controls = Y("controls", true), N.autoplay = D.autoplay, N.h = Y("inline"), N.muted = Y("muted"), N.src = P.src, L.appendChild(N); else {
        if ("node" === b) {
          N = P.src;
  ...
  function zb() {
    ...
    N && wb();
    if (T) {
      var a = document.fullscreen || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement;
      d(Ua, "on", a);
  ...
  function cb(a) {
    var b = document.fullscreen || document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement;
