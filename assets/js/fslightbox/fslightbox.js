!function (e, t) {
  ...
  return function (e) {
    ...
    return n.m = e, n.c = t, n.d = function (e, t, o) {
      ...
      if (n.r(o), Object.defineProperty(o, "default", {enumerable: true, value: e}), 2 & t && "string" != typeof e) for (var i in e) n.d(o, i, function (t) {
        return e[t];
      }.bind(null, i));
      return o;
    }, n.n = function (e) {
    ...
    function S(e) {
      ...
      n.getPreviousSlideIndex = function () {
        ...
        var n = t.current;
        if (0 === n && e === o || n === o && 0 === e) return true;
        var i = n - e;
        return -1 === i || 0 === i || 1 === i;
      };
    }
    ...
    function L(e) {
      ...
      this.getSourceTypeFromLocalStorageByUrl = function (e) {
        ...
        if (false === i[n] && (o--, "invalid" !== e ? i[n] = e : delete i[n], 0 === o)) {
          !function (e, t) {
    ...
    function A(e, t, n, o) {
      e.data;
      var i = e.elements.sources, r = n / o, s = 0;
    ...
    function C(e, t) {
      ...
      this.runActions = function (e, o) {
        a[t] = true, s[t].classList.add(x), r[t].classList.add(g), r[t].removeChild(r[t].firstChild), l(e, o), n.runActions = l;
      };
    }
    function E(e, t) {
    ...
    function z(e, t) {
      ...
      }, i[t].controls = true, I(e, t), c[t] && (i[t].poster = c[t]);
    ...
    function T(e, t) {
      ...
      r[t].src = "https://www.youtube.com/embed/".concat(c.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/)[2], "?").concat(l || ""), r[t].allowFullscreen = true, I(e, t), s[t].appendChild(r[t]), n[t].handleYoutubeLoad();
    }
    function P(e, t) {
      var n = e.collections.sourceLoadHandlers, o = e.elements, i = o.sources, r = o.sourceAnimationWrappers, s = e.props.sources;
    ...
    function H(e, t, n) {
      var o = e.props, i = o.types, r = o.type, s = o.sources;
    ...
    function W(e, t) {
      ...
      f.className = "".concat(d, " ").concat(a, " ").concat(c), f.s = function () {
        ...
        p(-((1 + s.slideDistance) * innerWidth));
      }, f.z = function () {
        p(0);
      }, f.p = function () {
        p((1 + s.slideDistance) * innerWidth);
    ...
    function O(e, t) {
      ...
      n.className = "".concat(i, "toolbar"), t.appendChild(n), function (e, t) {
        ...
        n.ofs = function () {
          o.ifs = true, s.title = "Exit fullscreen", a.setAttributeNS(null, "width", "24px"), a.setAttributeNS(null, "height", "24px"), a.setAttributeNS(null, "viewBox", "0 0 950 1024"), a.firstChild.setAttributeNS(null, "d", "M682 342h128v84h-212v-212h84v128zM598 810v-212h212v84h-128v128h-84zM342 342v-128h84v212h-212v-84h128zM214 682v-84h212v212h-84v-128h-128z");
        }, n.xfs = function () {
          o.ifs = false, s.title = "Enter fullscreen", a.setAttributeNS(null, "width", "20px"), a.setAttributeNS(null, "height", "20px"), a.setAttributeNS(null, "viewBox", "0 0 18 18"), a.firstChild.setAttributeNS(null, "d", r);
        }, s.onclick = i.t;
      }(e, n), function (e, t) {
        var n = M(t, "Close");
    ...
    function q(e) {
      ...
      this.runActionsForEvent = function (e) {
        ...
        i(o.current, "z"), undefined !== l && n.swipedX > 0 ? i(l, "ne") : undefined !== u && n.swipedX < 0 && i(u, "p");
      };
    }
    function V(e) {
    ...
    function U(e) {
      ...
      function s(e, t) {
        undefined !== e && (n[e].s(), n[e][t]());
      }
      this.runPositiveSwipedXActions = function () {
        var e = o.previous;
        if (undefined === e) r("z"); else {
          r("p");
          var n = o.next;
          t.changeTo(e);
          var a = o.previous;
    ...
    function Y(e) {
      var t = e.core.lightboxCloser, n = e.elements, o = e.resolve, i = e.sourcePointerProps, r = o(U);
      this.runNoSwipeActions = function () {
        _(n.container, n.slideSwipingHoverer), i.isSourceDownEventTarget || t.closeLightbox(), i.isPointering = false;
      }, this.runActions = function () {
        i.swipedX > 0 ? r.runPositiveSwipedXActions() : r.runNegativeSwipedXActions(), _(n.container, n.slideSwipingHoverer), n.container.classList.remove(s), i.isPointering = false;
      };
    }
    function J(e) {
      var t = e.resolve, n = e.sourcePointerProps, o = t(Y);
    ...
    function G(e) {
      ...
      this.isLightboxFadingOut = false, this.runActions = function () {
        t.isLightboxFadingOut = true, a.container.classList.add(v), i.removeListeners(), u.exitFullscreenOnClose && s.ifs && c.x(), setTimeout(function () {
          t.isLightboxFadingOut = false, d.isPointering = false, a.container.classList.remove(v), document.documentElement.classList.remove(l), r.removeRecompense(), document.body.removeChild(a.container), o.dispatch("onClose");
        }, 270);
      };
    }
    function $(e, t) {
    ...
    function K(e) {
      ...
      n = (t = e).core.eventsDispatcher, o = t.props, n.dispatch = function (e) {
        ...
        var t = e.core, n = t.globalEventsController, o = t.windowResizeActioner, i = e.fs, r = e.resolve, s = r(B), a = r(V), c = r(J);
        ...
        var t = e.core.lightboxCloser, n = (0, e.resolve)(G);
        ...
        o.changeTo = function (e) {
          ...
          d.d(n), d.c(), requestAnimationFrame(function () {
            requestAnimationFrame(function () {
              ...
              s && c[n].classList.add(m), f && c[u.current].classList.add(h), d.a(), undefined !== e && e !== n && a[e].ne(), a[u.current].n(), undefined !== o && o !== n && a[o].p(), d.b(t), d.b(i), l[n] ? setTimeout(p, 260) : p();
            });
          });
        };
      }(e), function (e) {
        ...
        t.listener = function (e) {
          "VIDEO" !== e.target.tagName && e.preventDefault(), r.isPointering = true, r.downScreenX = e.screenX, r.swipedX = 0;
          var t = i[s.current];
          t && t.contains(e.target) ? r.isSourceDownEventTarget = true : r.isSourceDownEventTarget = false;
        ...
        var t = e.collections.sourceSizers, n = e.core.windowResizeActioner, o = (e.data, e.elements.smw), i = e.props.sourceMargin, r = e.stageIndexes, s = 1 - 2 * i;
        n.runActions = function () {
          innerWidth > 992 ? e.mw = s * innerWidth : e.mw = innerWidth, e.mh = s * innerHeight;
          for (var n = 0; n < o.length; n++) o[n].d(), t[n] && t[n].adjustSize();
          var i = r.previous, a = r.next;
          undefined !== i && o[i].ne(), undefined !== a && o[a].p();
        };
      }(e);
    }
    function Q(e) {
      var t = e.componentsServices, n = e.core, o = n.eventsDispatcher, r = n.globalEventsController, s = n.scrollbarRecompensor, c = n.sourceDisplayFacade, u = n.stageManager, f = n.windowResizeActioner, p = e.data, h = e.elements, m = (e.props, e.stageIndexes), v = e.sws;
      function b() {
        var t, n;
        p.i = true, p.scrollbarWidth = function () {
      ...
      e.open = function () {
        var n = arguments.length > 0 && undefined !== arguments[0] ? arguments[0] : 0, i = m.previous, a = m.current, d = m.next;
    ...
    function ie() {
      for (var e = document.getElementsByTagName("a"), t = function (t) {
        ...
        var i = null;
        "#" === n.charAt(0) ? (i = document.getElementById(n.substring(1)).cloneNode(true)).removeAttribute("id") : i = n, fsLightboxInstances[o].props.sources.push(i), fsLightboxInstances[o].elements.a.push(e[t]);
